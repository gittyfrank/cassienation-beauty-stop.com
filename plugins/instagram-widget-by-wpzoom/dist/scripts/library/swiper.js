! function(e, t) {
    ...
    function y() {
        return w || (w = function() {
            const e = r(),
                t = a();
            return {
                smoothScroll: "scrollBehavior" in t.documentElement.style,
    ...
    const G = {
            ...
            update: {
                ...
                updateSlides: function() {
                    ...
                    for (let i = 0; i < p; i += 1) {
                        ...
                        if (C && e.grid.updateSlide(i, n, p, t), "none" !== n.css("display")) {
                            if ("auto" === a.slidesPerView) {
                                ...
                                if (i && (n[0].style.transform = "none"), r && (n[0].style.webkitTransform = "none"), a.roundLengths) S = e.isHorizontal() ? n.outerWidth(!0) : n.outerHeight(!0);
                                else {
                                    const e = s(t, "width"),
                                        a = s(t, "padding-left"),
                                        i = s(t, "padding-right"),
                                ...
                                i && (n[0].style.transform = i), r && (n[0].style.webkitTransform = r), a.roundLengths && (S = Math.floor(S))
                            } else S = (r - (a.slidesPerView - 1) * x) / a.slidesPerView, a.roundLengths && (S = Math.floor(S)), c[i] && (c[i].style[t("width")] = S + "px");
                    ...
                    if (e.virtualSize = Math.max(e.virtualSize, r) + v, n && l && ("slide" === a.effect || "coverflow" === a.effect) && i.css({
                        ...
                        }), C && e.grid.updateWrapperSize(S, u, t), !a.centeredSlides) {
                        const t = [];
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = S.bind(e), e.onTouchMove = M.bind(e), e.onTouchEnd = $.bind(e), s.cssMode && (e.onScroll = z.bind(e)), e.onClick = k.bind(e), i.touch && !O && (t.addEventListener("touchstart", I), O = !0), L(e, "on")
                },
    ...
    class X {
        ...
        emitContainerClasses() {
            ...
            const t = e.el.className.split(" ").filter(t => 0 === t.indexOf("swiper-container") || 0 === t.indexOf(e.params.containerModifierClass));
    ...
    function U(e, t, s) {
        const a = d(`<div class="swiper-slide-shadow${s?"-"+s:""}"></div>`);
        return e.transformEl ? t.find(e.transformEl).append(a) : t.append(a), a
    }
    ...
    const K = [function({
        ...
        function h() {
            ...
            s.removeClass(t.hiddenClass), s.removeClass(t.modifierClass + t.type), s.removeClass(t.modifierClass + e.params.direction), e.pagination.bullets && e.pagination.bullets.removeClass(t.bulletActiveClass), t.clickable && s.off("click", Y(t.bulletClass))
        }
        s("init", () => {
            u(), p(), c()
        }), s("activeIndexChange", () => {
        ...
        function T() {
            ...
            e.params.scrollbar = H(e, e.originalParams.scrollbar, e.params.scrollbar, {
                el: "swiper-scrollbar"
            });
        ...
        function T(t) {
            ...
            let r, n, l, o, p, h, f, g, v, w, b, x, y, E, T, C, S, M;
        ...
        s("beforeInit", () => {
            ...
            e.params.a11y.enabled && (function() {
                ...
                }), e.navigation && e.navigation.$nextEl && (m = e.navigation.$nextEl), e.navigation && e.navigation.$prevEl && (v = e.navigation.$prevEl), m && m.length && g(m, t.nextSlideMessage), v && v.length && g(v, t.prevSlideMessage), f() && e.pagination.$el.on("keydown", Y(e.params.pagination.bulletClass), h)
            }(), m())
        }), s("toEdge", () => {
        ...
        e.autoplay = {
            ...
            e.params.autoplay.enabled && (void 0 === r && !e.autoplay.running && (e.autoplay.running = !0, i("autoplayStart"), n()), a().addEventListener("visibilitychange", d), e.params.autoplay.pauseOnMouseEnter && (e.$el.on("mouseenter", u), e.$el.on("mouseleave", h)))
            ...
            e.$el.off("mouseenter", u), e.$el.off("mouseleave", h), e.autoplay.running && l(), a().removeEventListener("visibilitychange", d)
        ...
        t({
            ...
            "fade" === e.params.effect && (t => {
                const {
                    transformEl: s
                } = e.params.fadeEffect;
                (s ? e.slides.find(s) : e.slides).transition(t), _({
                    swiper: e,
                    duration: t,
                    transformEl: s,
                    allSlides: !0
        ...
        t({
            ...
            "flip" === e.params.effect && (() => {
                ...
                for (let i = 0; i < t.length; i += 1) {
                    ...
                    if (e.isHorizontal() ? s && (o = -o) : (p = c, c = 0, d = -o, o = 0), r[0].style.zIndex = -Math.abs(Math.round(n)) + t.length, a.slideShadows) {
                        ...
                        0 === t.length && (t = U(a, r, e.isHorizontal() ? "left" : "top")), 0 === s.length && (s = U(a, r, e.isHorizontal() ? "right" : "bottom")), t.length && (t[0].style.opacity = Math.max(-n, 0)), s.length && (s[0].style.opacity = Math.max(n, 0))
                    }
            ...
            "flip" === e.params.effect && (t => {
                const {
                    transformEl: s
                } = e.params.flipEffect;
                (s ? e.slides.find(s) : e.slides).transition(t).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(t), _({
                    swiper: e,
                    duration: t,
                    transformEl: s
                })
            ...
            "coverflow" === e.params.effect && (() => {
                ...
                for (let e = 0, t = a.length; e < t; e += 1) {
                    ...
                    if (F(r, t).transform(w), t[0].style.zIndex = 1 - Math.abs(Math.round(l)), r.slideShadows) {
                        ...
                        0 === e.length && (e = U(r, t, n ? "left" : "top")), 0 === s.length && (s = U(r, t, n ? "right" : "bottom")), e.length && (e[0].style.opacity = l > 0 ? l : 0), s.length && (s[0].style.opacity = -l > 0 ? -l : 0)
                    }
                }
            })()
        }), s("setTransition", (t, s) => {
            "coverflow" === e.params.effect && (t => {
                const {
                    transformEl: s
        ...
        s("beforeInit", () => {
            if ("custom" !== e.params.effect) return;
            e.classNames.push(e.params.containerModifierClass + "custom"), e.params.customEffect.perspective && e.classNames.push(e.params.containerModifierClass + "3d");
            const t = {
                watchSlidesProgress: !0,
                virtualTranslate: !e.params.cssMode
            };
            ...
            "custom" === e.params.effect && (() => {
                const {
                    slides: t
                } = e, s = e.params.customEffect;
                for (let i = 0; i < t.length; i += 1) {
                    const r = t.eq(i),
                        n = r[0].progress,
                        l = Math.min(Math.max(r[0].progress, -s.limitProgress), s.limitProgress),
                        o = r[0].swiperSlideOffset,
                        d = [e.params.cssMode ? -o - e.translate : -o, 0, 0],
                        c = [0, 0, 0];
                    let p = !1;
                    ...
                    l < 0 ? (u = s.next, p = !0) : l > 0 && (u = s.prev, p = !0), d.forEach((e, t) => {
                        d[t] = `calc(${e}px + (${a(u.translate[t])} * ${Math.abs(l)}))`
                    }), c.forEach((e, t) => {
                        c[t] = u.rotate[t] * Math.abs(l)
                    }), r[0].style.zIndex = -Math.abs(Math.round(n)) + t.length;
                    const h = d.join(", "),
                        m = `rotateX(${c[0]}deg) rotateY(${c[1]}deg) rotateZ(${c[2]}deg)`,
                        f = l < 0 ? `scale(${1+(1-u.scale)*l})` : `scale(${1-(1-u.scale)*l})`,
                        g = l < 0 ? 1 + (1 - u.opacity) * l : 1 - (1 - u.opacity) * l,
                        v = `translate3d(${h}) ${m} ${f}`;
                    if (p && u.shadow || !p) {
                        let e = r.find(".swiper-slide-shadow");
                        0 === e.length && u.shadow && (e = U(s, r)), e.length && (e[0].style.opacity = Math.min(Math.max(Math.abs(l), 0), 1))
                    }
                    const w = F(s, r);
                    w.transform(v).css({
                        opacity: g
                    }), u.origin && w.css("transform-origin", u.origin)
                }
            })()
        }), s("setTransition", (t, s) => {
            "custom" === e.params.effect && (t => {
                const {
                    transformEl: s
                } = e.params.customEffect;
                (s ? e.slides.find(s) : e.slides).transition(t).find(".swiper-slide-shadow").transition(t), _({
                    swiper: e,
                    duration: t,
                    transformEl: s
                })
        ...
        t({
            ...
            if ("cards" !== e.params.effect) return;
            e.classNames.push(e.params.containerModifierClass + "cards"), e.classNames.push(e.params.containerModifierClass + "3d");
            const t = {
                watchSlidesProgress: !0,
                virtualTranslate: !e.params.cssMode
            };
            ...
            "cards" === e.params.effect && (() => {
                ...
                for (let l = 0; l < t.length; l += 1) {
                    ...
                    if (a.slideShadows) {
                        ...
                        0 === e.length && (e = U(a, o)), e.length && (e[0].style.opacity = Math.min(Math.max(Math.abs(c), 0), 1))
                    }
                    o[0].style.zIndex = -Math.abs(Math.round(d)) + t.length, F(a, o).transform(x)
                }
            })()
        }), s("setTransition", (t, s) => {
            "cards" === e.params.effect && (t => {
                const {
                    transformEl: s
